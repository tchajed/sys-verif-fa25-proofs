...
Definition msets' : list (go_string * (list (go_string * val))) := [(Memoize.id, [("Call"%go, Memoize__Callⁱᵐᵖˡ)]); (ptrT.id Memoize.id, [("Call"%go, (λ: "$recvAddr",
                 method_call #memoize.memoize #"Memoize" #"Call" (![#Memoize] "$recvAddr")
